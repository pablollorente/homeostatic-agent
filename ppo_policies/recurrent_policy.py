...
class RecurrentPolicy(AbstractPolicy, ImaginationPolicy):
    def __init__(self, input_dim, actions_dim, training_config, imagination = False, device = "cpu"):
        ...
        self._actor_params = list(self._actor_board_processor.parameters())
        self._critic_params = list(self._critic_board_processor.parameters())
        ...
        if self._imagination:
            ...
            self._actor_params += list(self._actor_imagined_board_processor.parameters())
            self._critic_params += list(self._critic_imagined_board_processor.parameters())
        ...
        self._actor_params += list(self._actor_lstm.parameters()) + list (self._actor.parameters())
        self._critic_params += list(self._critic_lstm.parameters()) + list(self._critic.parameters())
